...
def game_board(game_map, player=0, row=0, column=0, just_display=False):
    ...
    try:
        ...
        print("Make sure you choose a number between 0, 1 and 2! (IndexError)")
        return False
...
while play:
    ...
    while not game_won:
        ...
        while not played:
            ...
            column_choice = int(input("Which column Do You Want To Choose? "))
            row_choice = int(input("Which row Do You Want To Choose? "))
